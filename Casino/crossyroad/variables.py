...
# ============================================================================
# CROSSY ROAD SETTINGS
# ============================================================================

MIN_BET = 10
MAX_BET = -1  # set to -1 for no limit

# Percentage chance (1-100) of a car appearing per lane hop
CAR_CHANCE = 35

# Payout multiplier (of original bet) per number of lanes successfully crossed
# Index 0 = 1 lane crossed, index 6 = 7 lanes crossed (maximum)
LANE_MULTIPLIERS = [1.7, 2.2, 3.0, 4.5, 7.0, 12.0, 20.0]
