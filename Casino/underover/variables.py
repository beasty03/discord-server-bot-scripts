...
# Total-return multipliers (includes original bet) for each bet type.
# Under 7 (15/36 ≈ 41.7%) and Over 7 (15/36 ≈ 41.7%) pay 2.2× → ~91.7% RTP.
# Exactly 7 (6/36 ≈ 16.7%) pays 5.5× → ~91.7% RTP.
PAYOUT_UNDER = 2.2
PAYOUT_EXACT = 5.5
PAYOUT_OVER  = 2.2
