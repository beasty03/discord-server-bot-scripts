...
SHOP_ITEMS = [
    ...
    # ── Wizard spell scrolls — consume via /learn_spell to learn permanently ──
    {
        "id":          "scroll_misty_step",
        "name":        "Scroll of Misty Step",
        "emoji":       "📜",
        "description": "Permanently teaches a Wizard the Misty Step spell (teleport, half dmg). Wizard Lv 3+.",
        "price":       400,
        "max_qty":     1,
        "tier":        "rare",
    },
    {
        ...
        "emoji":       "📜",
        "description": "Permanently teaches a Wizard the Scorching Ray spell (3 fire rays). Wizard Lv 3+.",
        "price":       300,
        "max_qty":     1,
        "tier":        "rare",
    },
